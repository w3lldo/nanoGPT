...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        # =====================================================================
        # THE FUSION OF MEANING AND TIME (tok_emb + pos_emb)
        # Attention is mathematically a "Bag of Words" and has no concept of order. 
        # To fix this, we literally fuse the Dictionary Meaning with a GPS Location.
        # EXAMPLE (If embedding size was 4-D, and the word was "Dog" at Position 0):
        #   [ 1.5, -0.2,  0.8,  3.1 ]  <-- tok_emb("Dog")
        # + [ 0.1,  0.5, -0.1,  0.0 ]  <-- pos_emb(Position 0)
        # ---------------------------
        # = [ 1.6,  0.3,  0.7,  3.1 ]  <-- The final `x` vector entering the Blocks!
        # The positional numbers slightly "warp/flavor" the original meaning so that 
        # the Attention mechanism can tell identical words apart based on their index.
        # =====================================================================
